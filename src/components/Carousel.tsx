...
const phrases = [
  ...
  { title: "El silencio también es violencia", text: "A veces pensamos que, si no decimos nada, no estamos contribuyendo al problema, pero el silencio también ayuda a que la violencia siga existiendo. ¡Las palabras son el primer paso para luchar contra la violencia de género!", name: "Silvia Argüello" },
  { title: "Ninguna mujer está sola, somos muchas luchando por la justicia", text: "Este mensaje es un recordatorio de que no tienes que enfrentar la violencia sola. Somos muchas las que estamos luchando para acabar con ella. ¡Juntas somos más fuertes! 💜", name: "Héctor Serna" },
  { title: "La igualdad es el primer paso para erradicar la violencia", text: "Si realmente queremos que la violencia de género desaparezca, necesitamos empezar por construir una sociedad en la que todos tengamos las mismas oportunidades y derechos.", name: "Karla De León" },
